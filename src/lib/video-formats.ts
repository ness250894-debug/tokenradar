...
export const VIDEO_FORMATS = [
  ...
  },
  {
    ...
    summaryLead: "The data matters most when it shows what would invalidate the signal.",
  ...
  },
  {
    ...
    summaryLead: "A token signal is stronger when it makes sense against the broader market backdrop.",
  ...
  },
  {
    ...
    captionInstruction: "Make the post about whether the move can hold, not whether it can pump.",
    ...
    summaryLead: "Strong moves can still fade if confirmation and liquidity do not hold.",
    verdictKicker: "MOMENTUM DESK",
    signalLabel: "HOLD THE LEVEL",
  ...
  },
  {
    ...
    summaryLead: "Percent gains need depth and volume behind them before the signal gets cleaner.",
  ...
  },
  {
    ...
    label: "Data vs Hype",
    family: "explainer",
    angle: "separate measurable signals from social noise",
    ...
    contextLead: "This format uses measurable market data to separate signal from noise.",
  ...
  },
  {
    ...
    summaryLead: "A clean signal should make sense after risk, liquidity, and volatility are checked.",
  ...
  },
  {
    ...
    summaryLead: "The stronger recap connects the token signal back to market context.",
  ...
  },
  {
    ...
    summaryLead: "Newly tracked names need stricter filters before the signal becomes useful.",
  ...
  },
  {
    ...
    hookSubline: "Educational Market Data Only | Tension creates the signal",
    revealLabel: "Tension Setup",
    metricsTitle: "Contrarian Data",
    contextTitle: "Signal Tension",
    ...
    summaryLead: "The useful part of a signal is often the tension between momentum and risk.",
