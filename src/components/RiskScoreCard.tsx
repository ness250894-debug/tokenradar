 ...
 */
export function RiskScoreCard({ score, label = "Risk Score", hideLabel = false }: RiskScoreCardProps) {
  ...
  return (
    <div className="stat-card-premium" style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%" }}>
